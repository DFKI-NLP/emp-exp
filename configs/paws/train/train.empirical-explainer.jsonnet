...
local name_file_train = "google-electra-small-discriminator.huggingface.paws.train.shapley-sampling.samples-20.batch-1to-1.jsonl";
# name of the validation set of explanations, assumed in <base-dir>/explanations/
local name_file_validation = "google-electra-small-discriminator.huggingface.paws.validation.shapley-sampling.samples-20.batch-1to-1.jsonl";
